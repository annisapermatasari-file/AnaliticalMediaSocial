  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-card transition-all duration-200 hover:-translate-y-1 hover:shadow-card-lg">
      <div className={`relative flex aspect-[4/3] items-center justify-center overflow-hidden bg-gradient-to-br ${product.thumbnailUrl}`}>
        ...
        <ImageIcon className="text-white/80" size={36} strokeWidth={1.5} />
      ...
      <div className="flex flex-1 flex-col gap-2.5 p-4">
        ...
        <div className="mt-1 flex flex-col gap-2">
          <button className="flex items-center justify-center gap-1.5 rounded-xl bg-teal-600 px-3 py-2.5 text-xs font-bold text-white shadow-card transition-all hover:bg-teal-700 active:scale-[0.98]">
            <Download size={14} /> Download Aset
          </button>
          <div className="flex gap-2">
            <button className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-teal-900/10 px-3 py-2 text-xs font-semibold text-ink-light hover:bg-surface-alt">
    ...
    <div className="flex gap-3 rounded-xl bg-surface p-3 transition-colors hover:bg-surface-alt">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex flex-wrap gap-1.5">
          ...
          <button className="flex items-center gap-1 rounded-lg border border-teal-200 px-2.5 py-1.5 text-[11px] font-semibold text-teal-700 hover:bg-white">
